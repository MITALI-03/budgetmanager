    ...
    <div className="container">
      <main className="p-5">
        <h1 className="text-warning">
          iNotes - Manage your notes on the cloud
        </h1>
        <p className="fs-6 col-md-8 my-3">
          Quickly and easily manage your personal notes on the cloud. Sign Up to
          iNotes and easily take notes on the cloud for free. Your notes are
        ...
        <div className="row g-5">
          <div className="col-md-6">
            ...
            <p>
              iNotes is free to use, add free and open source platform to
